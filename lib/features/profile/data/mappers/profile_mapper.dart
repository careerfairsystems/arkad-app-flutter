...
class ProfileMapper {
  ...
  static Profile fromDto(ProfileSchema dto) {
    return Profile(
      ...
      foodPreferences: dto.foodPreferences?.isEmpty == true
          ? null
          : dto.foodPreferences,
      ...
      cvUrl: dto.cv == null || dto.cv!.isEmpty
          ? null
  ...
  static UpdateProfileSchema toUpdateDto(Profile profile) {
    return UpdateProfileSchema(
      (b) => b
        ...
        ..masterTitle = profile.masterTitle?.isNotEmpty == true
            ? profile.masterTitle
            : null
        ..linkedin = profile.linkedin?.isNotEmpty == true
            ? profile.linkedin
            : null
        ..foodPreferences = profile.foodPreferences?.isNotEmpty == true
