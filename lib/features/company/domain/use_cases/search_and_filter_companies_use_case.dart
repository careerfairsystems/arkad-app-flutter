...
class SearchAndFilterCompaniesUseCase extends UseCase<List<Company>, SearchAndFilterParams> {
  ...
  Future<Result<List<Company>>> call(SearchAndFilterParams params) {
    return _repository.searchAndFilterCompanies(
      params.query,
      params.filter,
    );
  }
