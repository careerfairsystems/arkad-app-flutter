  ...
  static ThemeData get lightTheme {
    return ThemeData(
      ...
      colorScheme: ColorScheme.light(
        ...
        background: ArkadColors.white,
        surface: ArkadColors.white,
        onPrimary: ArkadColors.white,
        onSecondary: ArkadColors.white,
        onError: ArkadColors.white,
        onBackground: ArkadColors.black,
        onSurface: ArkadColors.black,
      ),
  ...
  static ThemeData get darkTheme {
    return ThemeData(
      ...
      colorScheme: ColorScheme.dark(
        ...
        error: ArkadColors.lightRed,
        background: ArkadColors.arkadNavy,
        surface: ArkadColors.gray,
        onPrimary: ArkadColors.white,
        onSecondary: ArkadColors.white,
        onError: ArkadColors.white,
        onBackground: ArkadColors.white,
        onSurface: ArkadColors.white,
      ),
